...
\newcommand{\bubble}[1]{{\tcbox[on line,boxsep=0pt,left=2pt,right=2pt,top=2pt,bottom=2pt,colframe=middle,colback=light]{#1}
}}
...
\subsection*{Experience}
    ...
    \begin{adjustwidth}{10pt}{10pt}
        ...
        \info{skills}: \bubble{python} \bubble{rust} \bubble{sql} \bubble{rabbitmq} \bubble{postgresql} \bubble{kubernetes} \bubble{redis}
        ...
        \info{skills}: \bubble{python} \bubble{mongodb} \bubble{distributed systems}
        ...
        \info{skills}: \bubble{python} \bubble{c++} \bubble{networking} \bubble{elasticsearch}
